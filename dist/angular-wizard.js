 ...
 * @version v0.5.11 - 2016-01-12 * @link https://github.com/mcorrand/angular-wizard
        ...
        controller: ['$scope', '$element', '$log', 'WizardHandler', '$q', function($scope, $element, $log, WizardHandler, $q) {
            ...
            $scope.$watch('currentStep', function(step) {
                ...
                if ($scope.selectedStep && stepTitle !== $scope.currentStep) {
                    ...
                    $scope.goTo(getStepWithTitle($scope.getEnabledSteps(), $scope.currentStep));
                }
            ...
            var getStepWithTitle = function(collection, title) {
            ...
            this.goTo = function(step) {
                ...
                if (angular.isNumber(step)) {
                    ...
                    stepTo = getStepWithTitle(enabledSteps, step);
                }
                //going to step
                $scope.goTo(stepTo);
            };
